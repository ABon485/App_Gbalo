...
api.interceptors.request.use(
  async (config: InternalAxiosRequestConfig) => {
    const authRoutes = ['/Login', '/LoginByEmail', '/LoginByPhone', '/Accounts/Resgiter','/Accounts/SendResgiterCode','/Accounts/ResgiterByCode','/Accounts/VerifyResgiterCode','/Accounts/Profile','/SendLoginCode','/LoginByCode','/Accounts/ChangePassByCode','/Accounts/VerifyChangePassCode',]
